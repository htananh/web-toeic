...
<body>
 <main class="main" id="top">
      ...
      <section>
        ...
        <div class="container">
          <div class="row">
            <h1 class="text-center mb-5">Làm Bài Thi Toeic Online</h1>
            <c:forEach var="list" items="${ListExamination}">
            	 <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="imageExamination/${list.examinationimage}" alt="courses" />
                <div class="card-body">
                  <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">${list.examinationame}</h5>
                  <a class="text-muted fs--1 stretched-link text-decoration-none" href="ExaminationQuestionController?examinationid=${list.examinationid}">${list.examinationid}</a>
                </div>
              </div>
            </div>
  ...
  <c:when test="${pageNumber==1}">
    ...
    <li  class="page-item"><a style="color:black;" class="page-link" href="ExaminationUserController?page=1">1</a></li>
    <li class="page-item"><a style="color:black;" class="page-link" href="ExaminationUserController?page=2">2</a></li>
    <li class="page-item"><a style="color:black;" class="page-link" href="ExaminationUserController?page=${pageNumber+1}">Next</a></li>
  </ul>
  </c:when>
  <c:when test="${pageNumber==MaxDisplay}">
    <ul class="pagination">
    <li class="page-item"><a style="color:black;" class="page-link" href="ExaminationUserController?page=${pageNumber-1}">Previous</a></li>
    <li class="page-item"><a style="color:black;" class="page-link" href="ExaminationUserController?page=1">1</a></li>
    <li class="page-item"><a style="color:black;" class="page-link" href="ExaminationUserController?page=2">2</a></li>
