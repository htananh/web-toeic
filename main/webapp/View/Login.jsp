                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <small style="color: red"><%= request.getAttribute("messageLogin")!=null?request.getAttribute("messageLogin"): " " %></small>
                                    </div>
                                    ...
                                    <hr>
                                    <div class="text-center" onclick="notifyFeatureUpdate()">
                                        <a class="small">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="RegisterForward">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
