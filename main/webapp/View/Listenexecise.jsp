...
<body>
 <main class="main" id="top">
      ...
      <section>
        ...
        <div class="container">
          <div class="row">
            ...
            <c:forEach var="list" items="${ListListenexecise}">
            	 <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="imageExamination/${list.listenexeciseimage}" alt="courses" />
                <div class="card-body">
                  <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">${list.listenexecisename}</h5>
                  <a class="text-muted fs--1 stretched-link text-decoration-none" href="ListeningQuestionController?listenexeciseid=${list.listenexeciseid}">${list.listenexeciseid}</a>
                </div>
              </div>
            </div>
  ...
  <c:when test="${pageNumber==1}">
    ...
    <li  class="page-item"><a style="color:black;" class="page-link" href="ListenexeciseUserController?page=1">1</a></li>
    <li class="page-item"><a style="color:black;" class="page-link" href="ListenexeciseUserController?page=2">2</a></li>
    <li class="page-item"><a style="color:black;" class="page-link" href="ListenexeciseUserController?page=${pageNumber+1}">Next</a></li>
  </ul>
  </c:when>
  <c:when test="${pageNumber==MaxDisplay}">
    <ul class="pagination">
    <li class="page-item"><a style="color:black;" class="page-link" href="ListenexeciseUserController?page=${pageNumber-1}">Previous</a></li>
    <li class="page-item"><a style="color:black;" class="page-link" href="ListenexeciseUserController?page=1">1</a></li>
    <li class="page-item"><a style="color:black;" class="page-link" href="ListenexeciseUserController?page=2">2</a></li>
